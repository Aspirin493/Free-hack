...
bool C_BaseEntity::IsPlayer()
{
	...
	if (this == nullptr || GetClientClass() == nullptr || !GetClientClass()->m_ClassID)
		return false;
...
void C_BasePlayer::UpdateAnimationState(CCSGOPlayerAnimState *state, QAngle angle)
{
	...
	static auto UpdateAnimState = reinterpret_cast<fn>(Utils::PatternScan(
...
void C_BaseAttributableItem::SetModelIndex(const int index)
{
...
{
	return !this || !IsPlayer() || this == g_LocalPlayer || m_iHealth() <= 0 || !IsAlive() || m_bGunGameImmunity() || (m_fFlags() & FL_FROZEN);
}