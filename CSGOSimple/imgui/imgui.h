...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox3(const char* label, bool* v, int* priority);
    ...
    IMGUI_API ImVec2 CalculateTextCenter(const ImVec2& ElementSize = { 0.0f, 0.0f }, const char* szText = "Text");
